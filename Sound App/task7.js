...
function drawVisualisation() {
	//first, get canvas
	var canvas = document.getElementsByClassName("player");
	
	var closestCanvas = canvas[1].closest('.player');
		
	var context = closestCanvas.getContext("2d");
	
	// 	//programmatically set the canvas width and height 
		closestCanvas.width = WIDTH;
		closestCanvas.height = HEIGHT;
